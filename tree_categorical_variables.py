...
class H2ODecisionTree:
    ...
    def download_mojo(self):
    	return self.model.download_mojo(get_genmodel_jar=True)

    def download_pojo(self):
    	return self.model.download_pojo()
...
def evaluate_h2o_model(
    ...
    metrics, feature_importances, models = list(), list(), list()
    ...
    for train_idx, test_idx in folds:
        ...
        models.append(model)
    return {'metric': metrics, 'importances': feature_importances, 'models': models}
